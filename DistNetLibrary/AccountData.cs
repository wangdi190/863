...
namespace DistNetLibrary
{
    ...
    public abstract class AcntTransformFacilityBase : AcntFacilityBase
    {
    ...
    public class AcntSubstation : AcntTransformFacilityBase
    {
        ...
        public int HBusbarLinkMode { get; set; }
        [Category("技术参数"), DisplayName("中压侧母线接线形式")]
        public int MBusbarLinkMode { get; set; }
        [Category("技术参数"), DisplayName("低压侧母线接线形式")]
        public int LBusbarLinkMode { get; set; }
