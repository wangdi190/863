...
namespace DNVLibrary.Run
{
    ...
    class RFullViewIndexFish : AppBase
    {
        ...
        internal override void load()
        {
            ...
            curcontrol.dataSource = DataLayer.DataProvider.getDataTableFromSQL("select cast(ID as nvarchar(100)) id, sort1,sort2,ord,indexname, definition,IMPORTANT,format,VALUE,UNIT,VALUENOTE,REFER1,REFER2,REFERTYPE,refernote from Dic_Index where Category='863' and isPeriod=0 order by ord,IMPORTANT");
