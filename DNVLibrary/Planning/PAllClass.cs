...
namespace DNVLibrary.Planning
{
    ...
    public abstract class IndexBase
    {
        ...
        public string gaugeformat { get; set; }  //仪表标签格式
    ...
    public class Indexes
    {
        ...
        public Indexes()
        {
            ...
            indexes.Add("变电容量（kW）", new Index() { format = "{V:f1}", min=1200,max=3500 });
            indexes.Add("供电负荷（kW）", new Index() { format = "{V:f1}", min = 1000, max = 3000 });
