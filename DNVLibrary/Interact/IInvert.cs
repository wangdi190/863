    ...
    class IInvert : BaseMain
    {
        ...
        protected override void load()  //进入时装载数据
        {
            if (IInvertController.uctop == null)
            {
                ...
                IInvertController.uctop.cmbProjects.SelectionChanged += new System.Windows.Controls.SelectionChangedEventHandler(cmbProjects_SelectionChanged);
            }
        ...
        void cmbProjects_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            IInvertController.ucpanel.changeProject();
        }
