...
namespace WpfEarthLibrary
{
    ...
    public abstract class PowerBasicObject : MyClassLibrary.MVVM.DependencyNotificationObject
    {
            ...
            set
            {
                ...
                if (parent != null && parent.parent != null)
                {
                    if (this is pSymbolObject)
                        ...
                        updateProperty(value, parent.parent.earth.earthkey, EModelType.折线, EPropertyType.颜色, hashcode, hashcode);
                        ...
                        updateProperty(value, parent.parent.earth.earthkey, EModelType.文字, EPropertyType.颜色, hashcode, hashcode);
                }
            }
        }
        #endregion
        ...
        ///<summary>类型排序号，地面类和几何体类, 限0-20</summary>
        public int typeOrd;
        ...
        ///<summary>深度序</summary>
        internal int deepOrd
        {
            get
            {
                //2147483648
                _deepOrd = typeOrd * 100000000 + (int)(groundHeight * 100000 * 1000000) + (int)((90 - latitude) * 10000);
                //_deepOrd = -_deepOrd;
                return _deepOrd;
            }
        }
    ...
    public class pSymbolObject : pDotObject
    {
        ...
        void sendD3D()
        {
            ...
            D3DManager.ChangeProperty(parent.parent.earth.earthkey, (int)EModelType.图元, (int)EPropertyType.材质, hashcode, hashcode, ipTexture, tcount, IntPtr.Zero, 0);
    ...
    public class pArea : pRangeObject
    {
        ...
        void buildMesh()
        {
            ...
            while (pidx.Count > 2)
            {
                ...
                v1 = (p1 - p2);
                v2 = p3 - p2;
                double ang = System.Windows.Vector.AngleBetween(v1, v2);
                if (ang <= 0)
                {
                    tuidx = tuidx + 1;
                }
    ...
    public class pContour : pRangeObject
    {
        ...
        void sendD3D()
        {
            ...
            D3DManager.ChangeProperty(parent.parent.earth.earthkey, (int)EModelType.等值图, (int)EPropertyType.材质, id.GetHashCode(), 0, ipTexture, tcount, IntPtr.Zero, 0);
            Marshal.FreeCoTaskMem(ipTexture);
    ...
    public class pData : pDotObject
    {
        ...
        void item_ValueChange(object sender, EventArgs e)
        {
            ...
            if (showType == EShowType.几何体)
            {
                ...
                updateProperty(zd.color, earthkey, EModelType.几何体, EPropertyType.颜色, datas[0].hashcode, zd.hashcode);
    ...
    public class pCustomObject : pDotObject
    {
        ...
        {
            get { return _scaleX; }
            set { _scaleX = value; updateProperty(value, parent.parent.earth.earthkey, EModelType.图元, EPropertyType.长度, hashcode, hashcode); }
        }
        ...
        {
            get { return _scaleY; }
            set { _scaleY = value; updateProperty(value, parent.parent.earth.earthkey, EModelType.图元, EPropertyType.宽度, hashcode, hashcode); }
        }
        ...
        {
            get { return _scaleZ; }
            set { _scaleZ = value; updateProperty(value, parent.parent.earth.earthkey, EModelType.图元, EPropertyType.高度, hashcode, hashcode); }
        }
